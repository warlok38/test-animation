...
export function Instances({ children, ...props }) {
  const { nodes } = useGLTF("/models/computers/computers_1-transformed.glb");
  ...
  return (
    <Merged {...props} castShadow receiveShadow meshes={instances}>
      {
        //@ts-expect-error
        (instances) => (
...
export function Computers(props: GroupProps) {
  const { nodes: n, materials: m } = useGLTF(
    "/models/computers/computers_1-transformed.glb"
  );
...
function ScreenText({ invert = false, x = 0, y = 1.2, ...props }) {
